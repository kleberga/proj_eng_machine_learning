...
# kedro_eng_mac_proj documentation build
...
from kedro_eng_mac_proj import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_eng_mac_proj"
author = "Kedro"
...
htmlhelp_basename = "kedro_eng_mac_projdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_eng_mac_proj.tex",
        "kedro_eng_mac_proj Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_eng_mac_proj",
        "Project kedro_eng_mac_proj codebase.",
        "Data-Science",
    )
]
